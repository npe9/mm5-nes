...
#ifndef MMC5DEV_SWIFT_H
#define MMC5DEV_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="MMC5Dev",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSApplication;
SWIFT_CLASS("_TtC7MMC5Dev11AppDelegate")
...
@class NSCoder;
@class NSEvent;
SWIFT_CLASS("_TtC7MMC5Dev9CHRCanvas")
@interface CHRCanvas : NSView
...
@class NSWindow;
SWIFT_CLASS("_TtC7MMC5Dev27PreferencesWindowController") SWIFT_AVAILABILITY(macos,introduced=14.0)
